...
/*template class MatrixX<int8_t>;
template class MatrixX<uint8_t>;
template class MatrixX<int16_t>;
template class MatrixX<uint16_t>;
template class MatrixX<int32_t>;
template class MatrixX<uint32_t>;
template class MatrixX<float>;
template class MatrixX<double>;*/
